 ...
 */
export function getJerusalemTimezoneOffset(): number {
 ...
 */
export function createJerusalemDateTime(dateString: string, timeString: string): Date {
  // Validate inputs
 ...
 */
export function createDatabaseTimestamp(dateString: string, timeString: string): string {
 ...
 * @returns Database timestamp string in YYYY-MM-DD HH:MM:SS format
 */
export function createEndTimeTimestamp(dateString: string, timeString: string): string {
 ...
 */
export function parseServerDateTime(fullDateString: string, _timezoneString?: string): { dateString: string; timeString: string } {
  if (!fullDateString) {
    const now = new Date();
    return {
 ...
 */
export function createJerusalemISOString(dateString: string, timeString: string): string {
  if (!dateString || !timeString) {
 ...
 */
export function createSimpleISOString(dateString: string, timeString: string): string {
  if (!dateString || !timeString) {
    return new Date().toISOString();
  }
 ...
 */
export function parseJerusalemISOString(isoString: string): Date {
  if (!isoString) {
    return new Date();
  }
 ...
 */
export function parseSimpleISOString(isoString: string): Date {
  if (!isoString) {
    return new Date();
  }
 ...
 */
export function formatDateTimeForDisplay(dateString: string, timeString: string): { date: string; time: string } {
  if (!dateString || !timeString) {
    const now = new Date();
    return {
